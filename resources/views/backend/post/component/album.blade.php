<div class="ibox">
    <div class="ibox-title">
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            <h5>{{__('messages.dashboard.album.name')}}</h5>
            <div class="upload-album"><a href="" class="upload-picture">{{__('messages.dashboard.album.chooseImage')}}</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="click-to-upload {{((!isset($gallery)||count($gallery)==0) ? '' : 'hidden')}}">
                    ...
                    <div class="small-text">{{__('messages.dashboard.album.note')}}</div>
                </div>
