        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <div class="uk-flex uk-flex-middle">
                        <a href="{{route('user.catalogue.permission')}}" class="btn btn-warning mt5 mr10"><i class="fa fa-wrench mr5"></i> {{__('messages.user.permission.name')}}</a>
                        <a href="{{route('user.catalogue.create')}}" class="btn btn-danger mt5"><i class="fa fa-plus mr5"></i> {{__('messages.user.catalogue.store.create.title')}}</a>
                    </div>
