@include('backend.dashboard.component.breadcrumb',['title'=> __('messages.user.catalogue.permission.title')])
...
<form action="{{ route('user.catalogue.updatePermission') }}" method="post" class="box">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title"><h5>{{__('messages.user.catalogue.permission.tableHeading')}}</h5></div>
