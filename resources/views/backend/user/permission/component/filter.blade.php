<form action="{{route('user.permission.index')}}">
        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <a href="{{route('user.permission.create')}}" class="btn btn-danger mt5"><i class="fa fa-plus mr5"></i> {{__('messages.user.permission.store.create.title')}}</a>
                </div>
            </div>
        </div>
    </div>
