@include('backend.dashboard.component.breadcrumb', ['title' => __('messages.post.catalogue.delete.title')])
@if ($errors->any())
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>{{__('messages.post.catalogue.delete.confirm')}} {{ $postCatalogue->name }}</p>
                        <p>{{__('messages.post.catalogue.delete.note')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">{{__('messages.post.catalogue.name')}} <span class="text-danger">(*)</span></label>
