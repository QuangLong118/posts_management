@include('backend.dashboard.component.breadcrumb', ['title' => __('messages.language.delete.title')])
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>{{__('messages.language.delete.confirm')}} {{ $language->name }}</p>
                        <p>{{__('messages.language.delete.note')}}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row mb15">
                            <div class="col-lg-6">
                                <div class="form-row">
                                    <label for="" class="control-label text-left">{{__('messages.language.name')}}<span class="text-danger">(*)</span></label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="canonicale" value="{{ old('canonical', ($language->canonical) ?? '' ) }}" class="form-control" placeholder="" autocomplete="off" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
